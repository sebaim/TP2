//Implementar los m�todos que permitan realizar las siguientes operaciones entre objetos de la clase: 
//suma de vectores
//resta de vectores
...
public class VectorMath {
	...
	public void generaVectorAleatorio ()
	{
		...
		for (int i=0; i < this.vector.length; i++)
			this.vector[i] = (double) random.nextInt(30);
